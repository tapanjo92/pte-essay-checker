...
import { signIn, signUp, confirmSignUp, getCurrentUser, signInWithRedirect } from 'aws-amplify/auth';
                ...
                {(mode === 'signin' || mode === 'signup') && (
                  <>
                    ...
                    <Button
                      ...
                      className="w-full py-3 bg-white hover:bg-gray-100 text-gray-900 font-medium rounded-lg transition-all duration-200 border border-gray-300 flex items-center justify-center gap-3"
                      disabled={loading}
                    >
